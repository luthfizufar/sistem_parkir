      ...
      exit();
        ...
        if ($row = mysqli_fetch_assoc($resultl)) {
            ...
            if ($row['add_card'] == 0) {
                ...
                if (!empty($Uname) && !empty($Number) && !empty($Email)) {
                    ...
                    if (!mysqli_stmt_prepare($result, $sql)) {
                        ...
                        if (!$row = mysqli_fetch_assoc($resultl)) {
                            ...
                            echo "Nomor Registrasi sudah diambil!";
                            exit();
                        }
                    }
                }
                ...
                echo "Kendaraan ini sudah ada";
                exit();
            }    
        }
        else {
            echo "Tidak ada Kartu yang dipilih!";
            exit();
        }
    }
}
    ...
    if (!mysqli_stmt_prepare($result, $sql)) {
      ...
      exit();
        ...
        if ($row = mysqli_fetch_assoc($resultl)) {
            ...
            if ($row['add_card'] == 0) {
                echo "Pertama, Anda perlu menambahkan Pengguna!";
                exit();
            }
            else{
                if (empty($Uname) && empty($Number) && empty($Email)) {
            ...
            echo "Tidak ada Pengguna terpilih yang akan diperbarui!";
            exit();
        }
    }
}
...
if (isset($_POST['delete'])) {
    ...
    if (empty($user_id)) {
        echo "Tidak ada pengguna yang dipilih untuk dihapus";
        exit();
    } else {
