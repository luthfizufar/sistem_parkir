...
if (isset($_POST['reset_pass'])) {
	...
	$message = '<p>Kami menerima permintaan pengaturan ulang kata sandi. Tautan untuk mengatur ulang kata sandi Anda ada di bawah. jika Anda tidak membuat permintaan ini, Anda dapat mengabaikan email ini</p>';
