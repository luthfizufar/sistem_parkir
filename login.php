...
<main>
  <h1 class="slideInDown animated">Silakan Login dengan Email Admin dan Kata Sandi</h1>
  <h1 class="slideInDown animated" id="reset">Silakan Masukkan Email Anda untuk mengirim tautan setel ulang kata sandi</h1>
<!-- Log In -->
<section>
