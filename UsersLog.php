...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated">Berikut adalah log harian Kendaraan</h1>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Filter Log Kendaraan Anda:</h3>
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      ...
                      <label for="Start-Date"><b>Pilih dari Tanggal:</b></label>
                      <input type="date" name="date_sel_start" id="date_sel_start">
                      <label for="End -Date"><b>Sampai Tanggal:</b></label>
                  ...
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      ...
                      <div class="panel-body">
                        <label for="Start-Time"><b>Pilih dari:</b></label>
                        <input type="time" name="time_sel_start" id="time_sel_start">
                        <label for="End -Time"><b>Sampai:</b></label>
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint"><b>Filter By Owner Name:</b></label>
                    <select class="card_sel" name="card_sel" id="card_sel">
                      <option value="0">Nama Pemilik Kendaraan....</option>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device"><b>Filter By Entry Basement No:</b></label>
